...
export default function Card({ title_ua, short_text, icon_url, onClick }: ServicesProps | MainServicesProps) {
  return (
    <label
      ...
      className="flex relative min-h-[220px] w-80 cursor-pointer flex-col rounded-2xl border bg-white/40 px-8 py-12 shadow backdrop-blur-lg delay-75 duration-100 hover:-translate-y-1 hover:bg-white hover:shadow-2xl"
    >
