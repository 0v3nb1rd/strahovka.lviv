        ...
        <div className="grid grid-cols-1 items-baseline gap-8 lg:grid-cols-3">
          <div>
            ...
            <div className="mt-8 flex space-x-6 text-gray-600">
              <a
                href="https://www.facebook.com/offroadfwd"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/offroadfwd/"
                target="_blank"
                className="hover:opacity-75"
                rel="noreferrer"
              >
              ...
              <a className="hover:opacity-75" href="https://twitter.com/home" target="_blank" rel="noreferrer">
              ...
              <a
                href="https://www.youtube.com/channel/UCVvMfGGYlCFiP9gDvOiESEw"
                target="_blank"
                className="hover:opacity-75"
                rel="noreferrer"
              >
